...
SUPABASE_URL = os.environ.get("SUPABASE_URL", "https://lczcurqeakneaiqxbwcf.supabase.co")
SUPABASE_KEY = os.environ.get("SUPABASE_KEY", "sb_secret_oxeMQWWCsuc7xBtf6-la2A_b3xOtl-E")
